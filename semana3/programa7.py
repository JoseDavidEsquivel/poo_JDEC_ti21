...
perimetrocirculo = 2*3.14159*radio # Operaciones para el calculo de perimetro
areacirculo = 3.14159*radio**2 # Operaciones para el calculo de area
...
perimetrocuadrado= 4*lado # Operaciones para el calculo del perimetro
areacuadrado= lado**2 # Operaciones para el calculo del area 
